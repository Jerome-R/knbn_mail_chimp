...
class UpdateTrackingCommand extends ContainerAwareCommand
{ 
	protected function configure() 
	{ 
		$this 
			->setName('cron:updateTracking') 
	...
	{ 
		...
		$import = $this->getContainer()->get('cron.update.tracking');

		$import->updateTracking($input, $output);
